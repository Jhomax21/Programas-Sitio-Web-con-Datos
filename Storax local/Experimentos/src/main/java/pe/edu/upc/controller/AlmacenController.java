...
public class AlmacenController {
	...
	@PostMapping("/save")
	public String saveAlmacen(@Valid Almacen almacen, BindingResult result, Model model, SessionStatus status)
			throws Exception {
		...
		if (result.hasErrors()) {
			...
			if (rpta > 0) {
				...
				model.addAttribute("mensaje", "El nombre del almacén ya está registrado");
				return "almacen/formAlmacen";
	...
	@PostMapping("/saveup")
	public String saveAlmacenUpdate(@Valid Almacen almacen, BindingResult result, Model model, SessionStatus status)
			throws Exception {
